...
_EMPTY_FORM = {
    "url": "", "method": "GET", "location": "query",
    "max_words": "50", "rate_delay": "0", "extra": "",
}
...
def index():
    if request.method == "POST":
        ...
        token = _cache.put({"form": form, "result": result, "error": error})
        return redirect(url_for(".index", t=token))
    stashed = _cache.get(request.args.get("t")) or {}
    return render_template("param_miner/index.html",
                            form=stashed.get("form", dict(_EMPTY_FORM)),
