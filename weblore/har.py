"""HAR 1.2 importer — pull browser-recorded sessions into a Weblore project.
...
table via :py:meth:`weblore.storage.Project.add_history`.

This module is stdlib-only and never sends traffic.

Usage::

    from weblore.har import import_har_file
