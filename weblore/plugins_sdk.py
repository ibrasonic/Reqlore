...
def make_info(*, name: str, version: str = "0.1",
              ...
              author: str = "",
              homepage: str = "",
              min_weblore: str = "0.1") -> dict[str, Any]:
...
def make_passive_rule(name: str, *, severity: str = "info") -> Callable:
    ...
    def deco(fn: Callable) -> Callable:
        fn.weblore_rule_name = name              # type: ignore[attr-defined]
        fn.weblore_rule_severity = severity      # type: ignore[attr-defined]
        return fn
    return deco
