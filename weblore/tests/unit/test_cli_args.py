...
Each subcommand should accept exactly the flags Weblore's docs and Docker
...
class TestBothSubcommand:
    def test_both_accepts_unsafe_bind(self):
        ...
        #   weblore both --project ... --host 0.0.0.0 ... --unsafe-bind
        # which used to crash with "unrecognized arguments: --unsafe-bind".
        ns = _parse(
            "both",
            "--project", "demo.weblore",
            "--host", "0.0.0.0",
            "--ui-port", "8787",
            "--proxy-port", "8080",
            "--unsafe-bind",
    ...
    def test_both_unsafe_bind_defaults_false(self):
        ns = _parse("both", "--project", "demo.weblore")
