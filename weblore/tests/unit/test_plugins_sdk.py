...
from weblore.plugins_sdk import (
...
def test_make_passive_rule_tags_callable():
    ...
    assert fn.weblore_rule_name == "my-rule"
    assert fn.weblore_rule_severity == "medium"
...
def test_example_extra_headers_rule_yields_finding(tmp_path: Path):
    ...
    from weblore.scanner.passive import RuleContext
