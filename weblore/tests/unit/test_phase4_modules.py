...
from weblore.graphql import parse_schema
from weblore.macros import Macro, MacroStep, run as run_macro
from weblore.poc import clickjacking_poc, csrf_fetch_poc, csrf_form_poc
from weblore.saml import inspect as saml_inspect
...
def test_macro_capture_json_path():
    ...
    from weblore.macros import _capture
