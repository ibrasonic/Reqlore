...
:py:data:`weblore.__version__`. No telemetry, no automatic downloads, and the
...
Manifest format::
    ...
    {"latest_version": "0.2.0", "released": "2026-07-01",
     "url": "https://example.org/weblore/0.2.0/"}
"""
...
DEFAULT_MANIFEST_URL = "https://weblore.invalid/manifest.json"
USER_AGENT = f"weblore/{__version__} (+update-check)"
